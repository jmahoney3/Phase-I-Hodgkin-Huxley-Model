...
%sets an impulse current of 5microamps/cm^2 for 50 timesteps of 0.001
%miliseconds (0.5ms)
I(1:50) = [5];
%shows the current return to 0 after the end of the impulse
I(51:numel(t))=[0];
...
ylabel('Voltage (mV)')
%axis([0 100 -80 0]) 
title('Membrane Voltage Resonse to a Step Pulse Over Time')
...
xlabel('Time(ms)')
title('Conductance Response to Step Pulse Over Time')
